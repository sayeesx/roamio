...
const mockVehicles: RentalVehicle[] = [
  { id: '1', name: 'Maruti Swift', type: 'car', brand: 'Maruti', fuel_type: 'petrol', price_per_day: 1200, seating_capacity: 5, location: 'Kochi', image_url: '/vehicles/swift.jpg', features: ['AC', 'Bluetooth', 'Power Steering'], is_available: true },
  { id: '2', name: 'Hyundai Creta', type: 'car', brand: 'Hyundai', fuel_type: 'diesel', price_per_day: 2200, seating_capacity: 5, location: 'Kochi', image_url: '/vehicles/creta.jpg', features: ['AC', 'Sunroof', 'Touchscreen'], is_available: true },
  { id: '3', name: 'Tata Nexon EV', type: 'car', brand: 'Tata', fuel_type: 'electric', price_per_day: 2500, seating_capacity: 5, location: 'Trivandrum', image_url: '/vehicles/nexon.jpg', features: ['AC', 'Fast Charging', 'Touchscreen'], is_available: true },
  { id: '4', name: 'Honda Activa 6G', type: 'bike', brand: 'Honda', fuel_type: 'petrol', price_per_day: 400, price_per_hour: 50, location: 'Kochi', image_url: '/vehicles/activa.jpg', features: ['Automatic', 'Underseat Storage'], is_available: true },
  { id: '5', name: 'Bajaj Pulsar NS200', type: 'bike', brand: 'Bajaj', fuel_type: 'petrol', price_per_day: 600, location: 'Trivandrum', image_url: '/vehicles/pulsar.jpg', features: ['ABS', 'Digital Console'], is_available: true },
  { id: '6', name: 'Ather 450X', type: 'bike', brand: 'Ather', fuel_type: 'electric', price_per_day: 700, location: 'Kochi', image_url: '/vehicles/ather.jpg', features: ['Touchscreen', 'Fast Charging', 'Navigation'], is_available: true },
  { id: '7', name: 'Trek Marlin 7', type: 'bicycle', brand: 'Trek', fuel_type: 'electric', price_per_day: 800, location: 'Munnar', image_url: '/vehicles/trek.jpg', features: ['Mountain Bike', '21 Speed', 'Disc Brakes'], is_available: true },
  { id: '8', name: 'Hero Lectro', type: 'bicycle', brand: 'Hero', fuel_type: 'electric', price_per_day: 500, location: 'Kochi', image_url: '/vehicles/lectro.jpg', features: ['Electric Assist', '25km Range'], is_available: true },
  { id: '9', name: 'Giant Escape 3', type: 'bicycle', brand: 'Giant', fuel_type: 'electric', price_per_day: 300, location: 'Alappuzha', image_url: '/vehicles/giant.jpg', features: ['City Bike', '7 Speed', 'Comfort Seat'], is_available: true },
  { id: '10', name: 'Toyota Innova', type: 'car', brand: 'Toyota', fuel_type: 'diesel', price_per_day: 2800, seating_capacity: 7, location: 'Trivandrum', image_url: '/vehicles/innova.jpg', features: ['AC', 'Spacious', 'AC Vents'], is_available: true },
  { id: '11', name: 'Maruti WagonR CNG', type: 'car', brand: 'Maruti', fuel_type: 'cng', price_per_day: 1000, seating_capacity: 5, location: 'Kozhikode', image_url: '/vehicles/wagonr.jpg', features: ['AC', 'Spacious', 'Economical'], is_available: true },
  { id: '12', name: 'TVS Jupiter', type: 'bike', brand: 'TVS', fuel_type: 'cng', price_per_day: 350, location: 'Thrissur', image_url: '/vehicles/jupiter.jpg', features: ['Automatic', 'Economical'], is_available: true },
]
